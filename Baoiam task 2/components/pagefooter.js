function FOOTER(){
    ...
    <div id="foo_menu">
        <div class="foo_menu_container">
            ...
            <ul>
                <li><img src="https://seeklogo.com/images/N/nykaa-logo-AA06314FB9-seeklogo.com.png" alt="nykaa logo"></li>
    ...
    <div id="foo_last">
        ...
        <div>
            <p><span>&copy;</span> 2022 Nykaa E-Retail Pvt. Ltd. All Rights Reserved.</p>
        </div>
    </div>`
}
export {FOOTER}